...
@section('content')
    ...
    <div id="faq_registration" class="infoput">
        <div class="container" style="margin: 0 5%;">
            <h1 class="infoputheader"><strong>※ {{ $data->question}} 등기 수정</strong></h1>
            <form id="faq_registration-form" method="POST"
                  action="{{ route('admin.faq_registration.update', $data->id) }}"
                ...
                <div class="row">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="form_content">
                                <select id="classification" name="classification" form="faq_registration-form">
                        ...
                        <tr>
                            <td class="savebutton" colspan="2">
                                <button type="submit" form="faq_registration-form" class="btn btn-success">
                                    저장하기
                                </button>
                            </td>
                        </tr>
