...
@section('content')
    <style>
        #faq_rehabilitation td {
            padding: 15px;
            padding-right: 20px;
        }

        #faq_rehabilitation input {
            overflow-x: auto;
            -ms-overflow-x: auto;
            overflow-y: auto;
            -ms-overflow-y: auto;
    ...
    <div id="faq_rehabilitation" class="infoput">
        <div class="container" style="margin: 0 5%;">
            <h1 class="infoputheader"><strong>※ {{ $data->question}} 개인 회생 수정</strong></h1>
            <form id="faq_rehabilitation-form" method="POST"
                  action="{{ route('admin.faq_rehabilitation.update', $data->id) }}"
                ...
                <div class="row">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="form_content">
                                <select id="classification" name="classification" form="faq_rehabilitation-form">
                        ...
                        <tr>
                            <td class="savebutton" colspan="2">
                                <button type="submit" form="faq_rehabilitation-form" class="btn btn-success">
                                    저장하기
                                </button>
                            </td>
                        </tr>
