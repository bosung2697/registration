...
@section('content')
    ...
    <div id="faq_bankruptcy" class="infoput">
        <div class="container" style="margin: 0 5%;">
            <h1 class="infoputheader"><strong>※ {{ $data->question}} 개인 파산 수정</strong></h1>
            <form id="faq_bankruptcy-form" method="POST"
                  action="{{ route('admin.faq_bankruptcy.update', $data->id) }}"
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="savebutton" colspan="2">
                                <button type="submit" form="faq_bankruptcy-form" class="btn btn-success">
                                    저장하기
                                </button>
                            </td>
                        </tr>
