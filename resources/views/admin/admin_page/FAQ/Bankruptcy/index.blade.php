...
@section('content')
    ...
    <div class="askingpage">
        <div style="display:flex; justify-content: space-between; align-items: center;"><h3>개인 파산 목록</h3>
            <div style="cursor:pointer; border:2px solid #e85254; background-color: #e85254; color:white; padding:0.5vw; font-size:1vw; -webkit-border-radius: 1vw;-moz-border-radius: 1vw;border-radius: 1vw;"
                 onclick="location.href='{{url('/admin/faq_bankruptcy/create')}}'">개인 파산 추가
            </div>
        </div>
    ...
    <script>
        ...
        function deleting(id) {
            ...
            if (confirm('글을 삭제합니다.')) {
                $.ajax({
                    type: 'DELETE',
                    url: '/admin/faq_bankruptcy/' + id
                }).then(function () {
                    window.location.href = '/admin/faq_bankruptcy/';
                })
            }
        }
    </script>
