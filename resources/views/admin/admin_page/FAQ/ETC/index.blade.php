...
@section('content')
    ...
    <div class="askingpage">
        <div style="display:flex; justify-content: space-between; align-items: center;"><h3>기타 항목 목록</h3>
            <div style="cursor:pointer; border:2px solid #e85254; background-color: #e85254; color:white; padding:0.5vw; font-size:1vw; -webkit-border-radius: 1vw;-moz-border-radius: 1vw;border-radius: 1vw;"
                 onclick="location.href='{{url('/admin/faq_etc/create')}}'">기타 항목 추가
            </div>
        </div>
            ...
            <table class="pagecontents">
                ...
                @forelse($data as $value)
                    <tr class="tothedetailpage"
                        onclick="location.href='{{ url('/admin/faq_etc/'.$value->id.'/edit') }}'">
    ...
    <script>
        ...
        function deleting(id) {
            ...
            if (confirm('글을 삭제합니다.')) {
                $.ajax({
                    type: 'DELETE',
                    url: '/admin/faq_etc/' + id
                }).then(function () {
                    window.location.href = '/admin/faq_etc/';
                })
            }
        }
    </script>
