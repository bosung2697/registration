...
@section('content')
    ...
    <div id="faq_in_common" class="infoput">
        <div class="container" style="margin: 0 5%;">
            <h1 class="infoputheader"><strong>※ {{ $data->question}} 개인 파산 및 개인 회생 공통 수정</strong></h1>
            <form id="faq_in_common-form" method="POST"
                  action="{{ route('admin.faq_in_common.update', $data->id) }}"
                ...
                <div class="row">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="form_content">
                                <select id="classification" name="classification" form="faq_in_common-form">
                                    ...
                                    @if($data->classification == 'faq_rehabilitation') selected
                                        @endif>개인 회생</option>
                                    <option class="listed" value="faq_in_common"
                                            @if($data->classification == 'faq_in_common') selected
                                            @endif>개인 파산 및 개인 회생 공통</option>
                        ...
                        <tr>
                            <td class="savebutton" colspan="2">
                                <button type="submit" form="faq_in_common-form" class="btn btn-success">
                                    저장하기
                                </button>
                            </td>
                        </tr>
