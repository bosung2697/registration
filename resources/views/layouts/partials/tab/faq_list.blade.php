...
<div class="faq_list">
    ...
    <div class="selector {{preg_match('/\/faq_registration/', $_SERVER['REQUEST_URI'])||
            preg_match('/\/faq_registration.+/', $_SERVER['REQUEST_URI']) ? 'active':''}}">등기</div>
    <div class="selector {{preg_match('/\/faq_bankruptcy/', $_SERVER['REQUEST_URI'])||
    preg_match('/\/faq_bankruptcy.+/', $_SERVER['REQUEST_URI']) ? 'active' : ''}}">개인파산</div>
    <div class="selector {{preg_match('/\/faq_rehabilitation/', $_SERVER['REQUEST_URI'])||
    preg_match('/\/faq_rehabilitation.+/', $_SERVER['REQUEST_URI']) ? 'active' : ''}}">개인회생</div>
    <div class="selector {{preg_match('/\/faq_in_common/', $_SERVER['REQUEST_URI'])||
    preg_match('/\/faq_in_common.+/', $_SERVER['REQUEST_URI']) ? 'active' : ''}}">개인파산 및<br>개인회생 공통</div>
    <div class="selector {{preg_match('/\/faq_etc/', $_SERVER['REQUEST_URI'])
    ||preg_match('/\/faq_etc.+/', $_SERVER['REQUEST_URI']) ? 'active' : ''}}">기타</div>
</div>